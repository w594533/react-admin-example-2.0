...
class BasicLayout extends Component {
	...
	render() {
		...
		return (
			<Layout>
				<HeaderCustom toggle={this.toggle} collapsed={this.state.collapsed} user={auth.data || {}} menus={routesConfigs.menus} />
				<Layout>
					...
					<Layout>
						<Content style={{ margin: '0 16px', overflow: 'initial', flex: '1 1 0' }}>
							<Routes routesConfig={routesConfigs.menus} auth={auth} />
						</Content>
